...
const problems = [
  ...
  },
  {
    ...
    solution: "With decades of experience in the home services industry, Inova Local's VAs understand the unpredictable nature of residential cleaning. They're trained to handle these disruptions professionally and efficiently, working with whatever communication tools you prefer - from simple phone systems to advanced CRM platforms. Because you only pay for actual usage rather than a full-time salary, it's an affordable solution that pays for itself. Your VA will manage all client change requests, update schedules instantly across all platforms, coordinate with your cleaning teams, and ensure everyone stays informed without you ever being interrupted during your important business activities.",
  ...
  },
  {
    ...
    solution: "Leveraging three decades of home services recruitment experience, Inova Local's VAs understand exactly what makes a great cleaning professional. They know which red flags to watch for, what questions reveal true work ethic, and how to identify candidates who will thrive in residential cleaning environments. They work with all major job boards and can integrate with your existing HR software, or handle everything through simple email and phone systems. At a fraction of the cost of a full-time HR person - since you only pay for actual recruiting time - they handle the entire hiring process from posting compelling job descriptions to conducting initial screenings, checking references, and presenting you with only the most qualified candidates ready for final interviews.",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Every cleaning business owner faces these same productivity killers. Here's how much time you're losing and how Inova Local fixes it.
          </p>
        </div>
